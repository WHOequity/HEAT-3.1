...
bgsd <- function(dat, bs=FALSE, bsiter = 200, simulated_results = NULL){
  ...
  return(list(inequal.bgsd=inequal.bgsd, se.bgsd.boot=se.boot,  se.bgsd.formula=se.formula, 
              se.lowerci.bgsd = ci$l, se.upperci.bgsd = ci$u))  
}
