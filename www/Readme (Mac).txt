...
-------------------------------------------------------------------------------
HEALTH EQUITY ASSESSMENT TOOLKIT (HEAT), BUILT-IN DATABASE EDITION, VERSION 3.1
...
of HEAT uses data from the WHO Health Equity Monitor database (2019 update).

This package contains the Health Equity Assessment Toolkit (HEAT), Built-in 
database edition, Version 3.1, the WHO Health Equity Monitor database (2019 
...
portable version of “R” and the portable edition of the web browser Google 
Chrome. This does not imply in any manner that the use of these products are 
endorsed or recommended by the World Health Organization in preference to 
others of a similar nature. R Portable and Chrome Portable do not require any 
installation.
...
toolkitshould automatically open in a Chrome Portable browser window. 
...
May 2019 ñ Version 3.1
- Update of the built-in Health Equity Monitor database (2019 update). 
...
2.4. No WHO endorsement of third-party software. The use of the “R” and Chrome 
software does not imply that “R” or Chrome products are endorsed or 
